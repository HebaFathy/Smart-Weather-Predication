...
title('Result of Backpropagetion Test 1 year "Min Temperature" for cairo');
...
%plot result of Training  
plot(tim2006min,Tmin,'b',tim2006min,trian_data_min,'m')
title('Result of Backpropagetion Training 1 Year  "Min Temperature" for alex');
xlabel('Days "2006"');
ylabel('Temperature');

%plot result of Test  
plot(tim2007min,Test_targetmin,'b-',tim2007min,test_output_min,'m -')
title('Result of Backpropagetion Test 1 year "Min Temperature"for alex');
xlabel('Days "First Months 2007" ');
ylabel('Temperature');
legend({'Actual','Result'})
...
%plot result of Training  
plot(tim2006min,Tmin,'b',tim2006min,trian_data_min,'m')
title('Result of Backpropagetion Training 1 Year  "Min Temperature" for hurgada');
xlabel('Days "2006"');
ylabel('Temperature');

%plot result of Test  
plot(tim2007min,Test_targetmin,'b-',tim2007min,test_output_min,'m -')
title('Result of Backpropagetion Test 1 year "Min Temperature" for hurgada');
xlabel('Days "First  Months 2007" ');
ylabel('Temperature');
legend({'Actual','Result'})
...
%plot result of Training  
plot(tim2006min,Tmin,'b',tim2006min,trian_data_min,'m')
title('Result of Backpropagetion Training 1 Year  "Min Temperature" for luxor');
xlabel('Days "2006"');
ylabel('Temperature');
